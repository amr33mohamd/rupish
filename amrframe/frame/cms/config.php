...
$main_folder = 'amrframe/frame/cms';
...
$config =array("htaccess"=>"$htaccess","main_folder" =>"$main_folder","theme"=>"$theme","helping_errors"=>"$helping_errors","static"=>"$static","installed"=>"$installed");
